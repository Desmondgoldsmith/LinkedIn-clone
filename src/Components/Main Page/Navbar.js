    ...
    <div className='Navbar fixed top-0 left-0 right-0 z-30 h-[60px]'>
        ...
        <div className = 'nav_section'>
         <ul>
          ...
          <li onClick = {()=>showMessages()}><TextsmsIcon/><span className = 'notification bg-red-500 text-white pl-1 pr-1 rounded-full -mt-[20px] ml-[16px]'>4</span><span className='nav_text'>Messaging</span></li>
