...
const rollup = () =>{
 setshowUp(true)
  ...
  return (
   ...
   {/* message section */}
   <div onClick = {(e)=>rollup()} className ={`w-[300px] cursor-pointer  bg-white z-50 fixed bottom-0 top-[340px] right-0 h-[50px] p-2 rounded-md`}>
     ...
     {/* content */}
     <div className = {`${rollup ? `h-[400px]` : `top-1`}  bg-white border border-red-600`}>
